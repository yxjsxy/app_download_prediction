...
accuracy_train = accuracy_score(train_label, predictions_train)
accuracy_test = accuracy_score(test_label, predictions_test)
recall_train = recall_score(train_label, predictions_train)
recall_test = recall_score(test_label, predictions_test)
...
auc_test = roc_auc_score(test_label, predictions_test)
print('Optimal model trained: ', model)
print('accuracy on training set: ', accuracy_train)
print('recall on training set: ', recall_train)
print('f1 score on training set: ', f1_train)
print('area under curve on training set: ', auc_train)
print('accuracy on test set: ', accuracy_test)
print('recall on test set: ', recall_test)
print('f1 score on test set: ', f1_test)
print('area under curve on test set: ', auc_test)
'''
Final output:
Optimal model trained:  XGBClassifier(base_score=0.5, booster='gbtree', colsample_bylevel=1,
       colsample_bytree=0.7, gamma=0.2, learning_rate=0.1,
       max_delta_step=0, max_depth=3, min_child_weight=5, missing=None,
       n_estimators=150, n_jobs=1, nthread=4, objective='binary:logistic',
       random_state=0, reg_alpha=0, reg_lambda=1,
       scale_pos_weight=439.251572327044, seed=40, silent=True,
       subsample=0.7)
accuracy on training set:  0.9841428571428571
recall on training set:  1.0
f1 score on training set:  0.22268907563025206
area under curve on training set:  0.9920533783880529
accuracy on test set:  0.9842333333333333
recall on test set:  0.8970588235294118
f1 score on test set:  0.20504201680672268
area under curve on test set:  0.940745100659534
'''
